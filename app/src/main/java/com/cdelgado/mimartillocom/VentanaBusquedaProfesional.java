...
public class VentanaBusquedaProfesional extends VentanaBase implements AdapterView.OnItemSelectedListener
{
    ...
    private VentanaBusquedaProfesional estaVentana;
    ...
    private boolean hayResultados;  // Indica si la pestaña de resultados muestra algún profesional
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_ventana_busqueda_profesional);
        ...
        listaProfesionales      = (ListView)    findViewById(R.id.listaProfesionales);
        ...
        String tituloActionBar = getResources().getString(R.string.VentanaBusqueda_txt_titulo_profesionales);
        ...
        listaProfesionales.setAdapter(miAdapter);

        // Deshabilitar el click sobre el ListView
        listaProfesionales.setSelector(android.R.color.transparent);
        ...
        // Comportamiento al pulsar en la ListView de las cabeceras de los profesionales que devolvió la búsqueda
        // Abrir una nueva ventana para mostrar los datos del profesional (si el elemento pulsado representa un profesional)
        listaProfesionales.setOnItemClickListener
        (
        ...
        registerForContextMenu(listaProfesionales);
    ...
    private void cargarSpinner_ParametrosBusqueda(ClaseParametro claseParametro, String id)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                Log.d("VentanaBusquedaPro", "Solicitando datos de spinner para la clase " + clase + "...");
    ...
    public void limpiarFormulario()
    {
        ...
        mostrarDistancia(0, getResources().getString( R.string.general_txt_unidadDistancia ) );
    ...
    // Devuelve un ArrayList<BasicNameValuePair> con los parámetros de búsqueda para una petición al servicio web PROFESSIONAL_SEARCH
    ...
    public void iniciarBusqueda()
    {
        ...
        else
        {
            ...
            if ( !Utils.dispositivoConectado(cm) )
            {
                String titulo = getResources().getString(R.string.titulo_servicio_PROFESSIONAL_SEARCH);
                String msg = getResources().getString(R.string.general_txt_dispositivoSinConexion);
                Utils.mostrarMensaje(estaVentana, msg, Utils.TipoMensaje.DIALOGO, Utils.CategoriaDialogo.ADVERTENCIA, titulo);
            }
            ...
            else
            {
                ...
                ServicioWeb miServicioWeb = new ServicioWeb(gestorSesion.usarConexionSegura(), ServicioWeb.Tipo.PROFESSIONAL_SEARCH, estaVentana);
                ...
                // Crear una tarea asíncrona para conectar con el servicio web
                TareaSegundoPlano tareaBuscarProfesionales = new TareaSegundoPlano(miClienteWeb,estaVentana,pDialog,null,null);

                // Ejecutar la tarea de buscar profesionales que conicidan con los criterios indicados (en un hilo aparte del principal)
                Log.d("VentanaBusquedaPro", "Buscando profesionales... : " + parametrosBusqueda);
                tareaBuscarProfesionales.execute();
            }
        }
    ...
    public void modificarFavorito(String id, boolean agregar, int pos)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                // Ejecutar la tarea de validar las credenciales (en un hilo aparte del principal)
                Log.d("VentanaBusquedaPro", accion +" en favoritos al profesional "+ id_profesional + "...");
    ...
    public void procesarResultado(TareaSegundoPlano tarea)
    {
        ...
        // Posibles errores del servicio PROFESSIONAL_SEARCH a los que se desea dar un tratamiento particular
        // ...
        ...
        if ( respuesta_OK )
        {
            ...
            else if ( miServicioWeb.getTipo()==ServicioWeb.Tipo.PROFESSIONAL_SEARCH )
            {
                procesarBusquedaProfesional(miServicioWeb.getRespuesta());
            }
        }
    }
    ...
    private void procesarParametrosBusqueda (RespuestaServicioWeb respuesta, String clase)
    {
        ...
        {
            opcionDefecto = "<Selecciona una actividad>";
            spinner = spnActividad;
        }
        ...
        // Crear el adapter para este spinner, cargar los datos recibidos y activarlo (por si no lo estaba ya)
        if ( spinner != null)
        {
    ...
    private void procesarModificarFavoritos (RespuestaServicioWeb respuesta, int pos)
    {
        ...
        try
        {
            infoPro = (Info_CabeceraProfesional) listaProfesionales.getItemAtPosition(pos);
        }
        catch (ClassCastException ex)
        {
            Log.e("VentanaBusquedaPro","Error al hacer un cast a Info_CabeceraProfesional desde el adapter (pos: "+ Integer.toString(pos) +")");
            return;
        }
        ...
        // Actualizar la vista de los favoritos encontrados (cambia el icono de la estrella de favorito)
        ((Adapter_CabeceraProfesional) listaProfesionales.getAdapter()).notifyDataSetChanged();
    ...
    // Procesamiento de la respuesta OK al servicio PROFESSIONAL_SEARCH
    private void procesarBusquedaProfesional (RespuestaServicioWeb respuesta)
    {
        ...
        if (tam < 1)
        {
            ...
            titulosProfesionales[0] = getResources().getString( R.string.VentanaBusqueda_txt_sinResultados_profesionales);
            ...
            Utils.mostrarMensaje(estaVentana, getResources().getString(R.string.msg_BuscarProfesional_OK_SinCoincidencias), Utils.TipoMensaje.TOAST, null, null);
        }
        ...
        {
            // La respuesta devuelve un ArrayList<ContenidoServicioWeb>,
            // pero el adapter para el spinner necesita un ArrayList<Info_CabeceraProfesional>
            ArrayList<Info_CabeceraProfesional> items = new ArrayList();

            for (int i=0; i<tam; i++)
            {
                Info_CabeceraProfesional item = (Info_CabeceraProfesional) respuesta.getContenido().get(i);
                items.add(item);
            }

            Adapter_CabeceraProfesional miAdapter = new Adapter_CabeceraProfesional(estaVentana, R.layout.elemento_cabecera_profesional, items);
            listaProfesionales.setAdapter(miAdapter);
            ...
            // Mostrar un toast de información al usuario
            Utils.mostrarMensaje(estaVentana, tam + " " + getResources().getString(R.string.msg_BuscarProfesional_OK_HayCoincidencias), Utils.TipoMensaje.TOAST, null, null);
        }
    }
    ...
    {
        // Si el elemento en cuestión es el ListView que contiene los profesionales encontrados por la búsqueda
        if ( v.getId()==R.id.listaProfesionales)
        {
            ...
            Object datosElementoSeleccionado = listaProfesionales.getAdapter().getItem(info.position);
            ...
            try
            {
                ...
                if (esFavorito)
                    opcionesMenu = getResources().getStringArray(R.array.menuContextual_ventanaBusquedaProfesional_cabeceraProfesional_esFavorito);
                else
                    opcionesMenu = getResources().getStringArray(R.array.menuContextual_ventanaBusquedaProfesional_cabeceraProfesional_noEsFavorito);
            }
            catch (ClassCastException ex)
            {
                opcionesMenu = null;
    ...
    public boolean onContextItemSelected(MenuItem item)
    {
        ...
        // Si el listView no contiene elementos (solo un texto indicando que está vacío),
        // entonces al hacer el casting saltará una excepcion que hemos de capturar
        Object datosElementoSeleccionado = listaProfesionales.getItemAtPosition(posLista);
    ...
    public boolean onCreateOptionsMenu(Menu menu)
    {
        ...
        if ( hayResultados )
            getMenuInflater().inflate(R.menu.menu_ventana_busqueda_profesional_con_resultados, menu);
        else
            getMenuInflater().inflate(R.menu.menu_ventana_busqueda_profesional_sin_resultados, menu);
    ...
    public boolean onMenuOpened(int featureId, Menu menu)
    {
        ...
        if(featureId == Window.FEATURE_ACTION_BAR && menu != null)
        {
            if(menu.getClass().getSimpleName().equals("MenuBuilder"))
            {
                ...
                {
                    Log.e("VentanaBusquedaProf", "onMenuOpened ", e);
                }
                catch(Exception e)
                {
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        switch ( item.getItemId() )
        {
            ...
            case R.id.menu_ordenar_nombre_asc:
                ...
                if ( listaProfesionales.getAdapter() instanceof Adapter_CabeceraProfesional )
                {
                    Adapter_CabeceraProfesional a = (Adapter_CabeceraProfesional) listaProfesionales.getAdapter();
            ...
            // Opción de ordenar los profesionales encontrados por favoritos primero
            case R.id.menu_ordenar_favoritos_primero:

                if ( listaProfesionales.getAdapter() instanceof Adapter_CabeceraProfesional )
                {
                    Adapter_CabeceraProfesional a = (Adapter_CabeceraProfesional) listaProfesionales.getAdapter();
                    a.ordenar(Info_CabeceraProfesional.Comparadores.Criterio.FAVORITOS_PRIMERO);
                }

                return true;


            // Opción de ordenar los profesionales encontrados por favoritos después
            case R.id.menu_ordenar_favoritos_despues:

                if ( listaProfesionales.getAdapter() instanceof Adapter_CabeceraProfesional )
                {
                    Adapter_CabeceraProfesional a = (Adapter_CabeceraProfesional) listaProfesionales.getAdapter();
                    a.ordenar(Info_CabeceraProfesional.Comparadores.Criterio.FAVORITOS_DESPUES);
                }
